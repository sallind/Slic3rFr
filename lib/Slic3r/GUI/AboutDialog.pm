...
sub new {
    ...
    my $self = $class->SUPER::new($parent, -1, 'A propos de Slic3r', wxDefaultPosition, [600, 270]);
    ...
    my $text =
        ...
        'Contributions by Henrik Brix Andersen, Nicolas Dandrimont, Mark Hindess, Mike Sheldrake, Daniel Sallin (Traduction) and numerous others.' .
        '</font>' .
        '</body>' .
        '</html>';
